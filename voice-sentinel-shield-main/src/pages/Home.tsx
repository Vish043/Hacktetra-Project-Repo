...
import { Mic, Upload, ShieldCheck, AlertTriangle, FileAudio, BookOpen } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav>
            <ul className="flex space-x-6">
              <li><Link to="/" className="text-gray-600 hover:text-sentinel-600 font-medium">Home</Link></li>
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-4">
                Detect AI Voice Scams <span className="text-sentinel-600">Instantly</span>
              </h1>
              <p className="text-lg text-gray-600 mb-8 max-w-lg">
                Our advanced technology helps you identify AI-generated voice content and protect yourself from sophisticated voice scams.
              </p>
              <div className="flex flex-wrap gap-4">
                <Link to="/upload">
                  <Button size="lg" className="bg-sentinel-600 hover:bg-sentinel-700">
                    <Upload className="mr-2 h-5 w-5" />
                    Upload Voice
                  </Button>
                </Link>
                <Link to="/upload">
                  <Button size="lg" variant="outline" className="border-sentinel-300 text-sentinel-600 hover:bg-sentinel-50">
              ...
              <div className="relative">
                ...
                <div className="relative bg-white p-6 rounded-lg shadow-lg">
                  <div className="flex justify-between mb-4">
                    ...
                    <div className="text-xs text-gray-500">Voice Sentinel Shield</div>
                  </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Why Use Voice Sentinel Shield?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
              ...
              <p className="text-gray-600">
                Our advanced algorithms can detect AI-generated voices with high accuracy, helping you avoid sophisticated scams.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
              ...
              <p className="text-gray-600">
                Upload suspicious voice messages or record directly to quickly check if the voice is authentic or AI-generated.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
              ...
              <p className="text-gray-600">
                Get educational resources and stay updated on the latest voice scam techniques to protect yourself and your loved ones.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-sentinel-600 py-12">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">Ready to Protect Yourself from Voice Scams?</h2>
          <Link to="/upload">
            <Button size="lg" variant="secondary" className="bg-white text-sentinel-600 hover:bg-gray-100">
