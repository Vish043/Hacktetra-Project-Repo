              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs">
                    <p>Our analysis determines if a voice is human or AI-generated based on subtle patterns and characteristics.</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </h2>
            <p className="text-gray-600">
              Voice authenticity evaluation using advanced AI detection technology
            </p>
          </div>
            ...
            <div className="lg:w-2/3">
              ...
              {!isLoading && (
                <div className="mt-8 bg-sentinel-50 border border-sentinel-100 rounded-lg p-5">
                  <h3 className="font-bold text-lg mb-2">What do these results mean?</h3>
                  ...
                  <h4 className="font-medium text-sentinel-700 mb-1">Next Steps:</h4>
                  <ul className="list-disc list-inside text-gray-700 space-y-1">
                    {analysisData.isReal ? (
                      <>
                        <li>Even with a high confidence score for human voice, remain vigilant if the call seems suspicious.</li>
                        <li>Verify the caller's identity through official channels if they request sensitive information.</li>
                      </>
                    ) : (
                      <>
                        <li>Be extremely cautious about any requests or information from this source.</li>
                        <li>Do not share personal information, financial details, or access codes.</li>
                        <li>Report the incident to relevant authorities or organizations.</li>
                      </>
                    )}
                  </ul>
                </div>
